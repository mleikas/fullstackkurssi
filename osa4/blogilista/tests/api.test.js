...
describe('UPDATING BLOGS:', () => {
    ...
    test('blog is not updated with invalid authorization token', async () => {
        ...
        await api
            ...
            .expect(response => { invalidTestToken = response.body.token })
...
describe('DELETING BLOGS:', () => {
    ...
    test('blog is not deleted with invalid authorization token', async () => {
